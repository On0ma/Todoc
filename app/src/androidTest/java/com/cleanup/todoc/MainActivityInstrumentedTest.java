...
public class MainActivityInstrumentedTest {
    ...
    public void addAndRemoveTask() {
        ...
        // int nbtasks = listTasks.getAdapter().getItemCount();
        ...
        // assertThat(listTasks.getAdapter().getItemCount(), equalTo(nbtasks + 1));

        onView(withId(R.id.img_delete)).perform(click());

        // assertThat(listTasks.getAdapter().getItemCount(), equalTo(nbtasks));
